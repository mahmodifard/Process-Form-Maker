...
namespace RectTrackerSharp
{
	...
	public class RectTracker : System.Windows.Forms.UserControl
	{
		...
		private void RectTracker_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
		{
            ...
            int tX = ((GComponents.GeneralComponent)PFC.FrmForProducer.SelectedObject).Location.X;
            int tY = ((GComponents.GeneralComponent)PFC.FrmForProducer.SelectedObject).Location.Y;
            ((GComponents.GeneralComponent)PFC.FrmForProducer.SelectedObject).Location = new Point(PFC.FrmForProducer.generalX, PFC.FrmForProducer.generalY) ;
            PFC.FrmForProducer.actionRecover.doing(2, (GComponents.GeneralComponent)PFC.FrmForProducer.SelectedObject);
            ((GComponents.GeneralComponent)PFC.FrmForProducer.SelectedObject).Location = new Point(tX, tY);
			Create();
			this.Visible = true;
